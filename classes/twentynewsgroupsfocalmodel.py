from .abstractfocalmodel import AbstractFocalModel, FocalLoss
...
class AbstractTwentyNewsGroupsFocalModel(AbstractFocalModel):

    def __init__(self, args):
        super(AbstractTwentyNewsGroupsFocalModel, self).__init__(args)
        #spacy.prefer_gpu()
...
class PoolCNNTwentyNewsgroupsFocalModel(AbstractTwentyNewsGroupsFocalModel):
