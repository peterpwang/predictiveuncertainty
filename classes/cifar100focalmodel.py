...
class AbstractCIFAR100FocalModel(AbstractFocalModel):
...
# Resnet50 Cifar 100 focal model
class Resnet50CIFAR100FocalModel(AbstractCIFAR100FocalModel):
...
# Densenet121 Cifar 100 focal model
class Densenet121CIFAR100FocalModel(AbstractCIFAR100FocalModel):
